...
export const WaveEffect = () => {
  ...
  return (
    <div style={{
      ...
      <motion.svg variants={svgVariants} initial='initial' animate='animate' xmlns="http://www.w3.org/2000/svg" style={{ marginBottom: 50 }} version="1.1" preserveAspectRatio="none" viewBox="0 0 1500 560">
        <motion.g fill="none">
          <motion.path strokeDasharray="0 1" variants={pathVariants} initial="initial" animate="animate" transition={{ duration: 3, ease: 'easeInOut', repeat: 4, repeatType: 'mirror'}}  d="M -537.7769702681783,269 C -462.78,284.8 -312.78,370.2 -162.77697026817833,348 C -12.78,325.8 62.22,137.2 212.22302973182167,158 C 362.22,178.8 437.22,440.4 587.2230297318217,452 C 737.22,463.6 812.22,213.4 962.2230297318217,216 C 1112.22,218.6 1229.67,458 1337.2230297318217,465 C 1444.78,472 1467.44,293.8 1500,251" stroke="rgba(255, 44, 85, 1)" strokeWidth="2"/>
